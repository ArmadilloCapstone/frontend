...
function StudentScheduleAdd() {
    ...
    useEffect(() => {
        axios.post('http://localhost/student_schedule/studentList') // url 모름.. 변경 필요할듯
    ...
    useEffect(() => {
        axios.post('http://localhost/student_schedule/AfterSchoolClassList') // url 모름.. 변경 필요할듯
            .then(function (response) {
                console.log(response.data);
    ...
    const submitStudentScheduleRecord = async (e) => {
        e.preventDefault();
        e.target.reset();
        await axios.post('http://localhost/student_schedule_submit', user)
            .then(function (response) {
                console.log(response.data);
