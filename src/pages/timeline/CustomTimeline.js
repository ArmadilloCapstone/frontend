...
function CustomTimeline() {
  ...
  useEffect(() => {
    axios.post('http://localhost:80/studentTimeFindAll/' + localStorage.getItem('userid'))
  ...
  useEffect(() => {
    axios.post('http://localhost:80/studentScheduleFindAll/' + localStorage.getItem('userid'))
      .then(function (response) {
  ...
  useEffect(() => {
    axios.post('http://localhost:80/studentFindAll/' + localStorage.getItem('userid'))
      .then(function (response) {
        console.log(response.data);
