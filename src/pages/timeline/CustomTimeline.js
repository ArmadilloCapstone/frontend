...
function CustomTimeline() {
  ...
  useEffect( () => {
    axios.post('http://13.209.104.24:8080/studentTimeFindAll')
  ...
  useEffect( () => {
    axios.post('http://13.209.104.24:8080/AfterSchoolClassFindAll')
        .then(function(response){
  ...
  useEffect( () => {
    axios.post('http://13.209.104.24:8080/studentScheduleFindAll')
        .then(function(response){
...
const setGroup = (el, i, ary, student_id) =>
  ...
  useEffect( () => {
    axios.post('http://13.209.104.24:8080/studentFindAll')
        .then(function(response){
          console.log(response.data);
